          ...
          <div style={{position:"relative",paddingTop:"9rem"}}>
            ...
            <div className='car-home' style={{margin:'0 auto',padding:'0 2.5rem',maxWidth:"1350px"}}>
              <div style={{position:"absolute",zIndex:"3",maxWidth:"550px"}}>
                ...
                <h1 style={{color:"#000",fontSize:"3.2rem",fontWeight:"bolder"}}>Save <span style={{color:"#ff4d30"}}>big</span> with our car rental</h1>
                <p className='home-text' >Rent the car of your dreams. Unbeatable prices, unlimited miles, flexible pick-up options and much more.</p>
              ...
              <img className='car-img' style={{position:"absolute",top:"5rem",right:"3%",zIndex:"2",width:"52%",minWidth:'550px'}} src="https://car-rental-ten.vercel.app/static/media/main-car.9b30faa59387879fa060.png" alt="" />
            </div>
            <Bookings/>
          </div>
        </section>
